...
public class TestPkoJB {
    public static void main(String[] args) throws IOException {
       ...
       Scanner skanerTxt = new Scanner(plik);
        new ParaBankJanka(skanerTxt, System.out).zrobOperacje(); ///<----- w klasie Bank pojawiła się nowa metoda  do wykonywania operacji. Stara metoda została oznaczona @Deprecated stara metoda to skanerTxt, nowa metoda to system.out
